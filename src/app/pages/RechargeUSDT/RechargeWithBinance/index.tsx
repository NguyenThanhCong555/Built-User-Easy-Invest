...
export const RechargeWithBinance = (props: Props) => {
  ...
  const moveToRechargeUSDT = () => {
    if (location.pathname === '/recharge/binance/complete') {
      navigation('/recharge');
      return;
    }

    if (location.pathname === '/recharge/binance') {
      navigation('/recharge');
      return;
    }
  ...
  return (
    <Frame titlePage={t('RechargeWithBank.titlePageBinance')} onMovePage={moveToRechargeUSDT}>
