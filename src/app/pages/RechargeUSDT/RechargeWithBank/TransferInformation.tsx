...
export const TransferInformation = (props: Props) => {
    ...
    <>
      <Center>
        <Stack align="center" spacing={14}>
          ...
          <Avatar src={GetListBank?.qr_code} w={150} h={150} />
        </Stack>
      </Center>
      ...
      <Group position="apart" w={'100%'}>
        <Text className="small_1-bold">{numberWithCommas((Number(usdt) * VNDPerUSDT).toFixed(3))} VND</Text>
        <CopyToolTip text={String(Number(usdt) * VNDPerUSDT)} />
      </Group>
      {/* content banking */}
      <Text className="small_6-regular" c={'var(--grey-black'} mt={16} mb={2}>
