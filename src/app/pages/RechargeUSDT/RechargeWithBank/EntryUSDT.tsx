...
import { Center, Group, TextInput, Text, createStyles, Button, Divider, FocusTrap } from '@mantine/core';
import { useTranslation } from 'react-i18next';
import { useDispatch, useSelector } from 'react-redux';
import { useNavigate } from 'react-router-dom';
import { rechargeActions } from 'store/slice/recharge';
import { selectAddUsdt, selectOperationStep, selectVNDPerUSDT } from 'store/slice/recharge/selector';
...
export const EntryUSDT = (props: Props) => {
  ...
  const VNDPerUSDT = useSelector(selectVNDPerUSDT);
  ...
  const handleContinue = () => {
    ...
    navigation('/recharge/bank/choose', { state: { usdt } });
  };
