...
export const ContentOfCardStakingSuccess = (props: ContentOfCardStakingProps) => {
  ...
  return (
    <Box px={12}>
      ...
      <Accumulation
        mark
        label={t('StakedDetail.rate-at-stake-time')}
        value={`1 USDT = ${numberWithCommas(Number(props?.coin_info?.rate_usdt_coin).toFixed(3))} ${props?.coin_info?.coin_name}`}
        maw_label={!largeThan576 ? 90 : 'auto'}
        my={10}
      />
      <Accumulation
        mark
        ...
        maw_label={!largeThan576 ? 115 : 'auto'}
        my={10}
      />
      <Accumulation
        mark
      ...
      <Accumulation
        mark
        label={t('StakedDetail.complete-time')}
        value={ConvertDate.getDDMMYY(new Date(props?.time_withdraw ?? 0))}
        my={10}
      />
      ...
      <Accumulation
        ...
        value={numberWithCommas(Number(props.profit).toFixed(3))}
        unitValue={props?.coin_info?.coin_name}
        maw_label={!largeThan576 ? 115 : 'auto'}
        my={10}
      />
