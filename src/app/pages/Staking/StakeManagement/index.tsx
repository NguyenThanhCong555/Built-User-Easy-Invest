...
import {
  ...
  selectCalledTotal,
  selectLoadingStakingBook,
  selectStakingBook,
  selectTotalPage,
  selectTotalPageLocal,
  selectTotalUsdt,
...
import { FilterStake, FilterStakeProps } from '../components/Filter';
...
export const StakeManagement = () => {
  ...
  const loadingStakingBook = useSelector(selectLoadingStakingBook);
  ...
  useEffect(() => {
    ...
    if (!calledStakingBook) {
      dispatch(stakeActions.requestFilterStakingBook(dataFilter));
    }
  }, []);
