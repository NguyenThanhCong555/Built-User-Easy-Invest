...
const EditOtpInput = memo(({ phone, onSendBack }: Props) => {
  ...
  const handleCompleteOtpInput = () => {
    ...
    dispatch(withdrawActions.requestEditWithdrawUsdt(payload));
  };
