...
import { WithdrawRequestGame } from 'store/slice/withdraw/request';
import { dataBinanceAccount } from '../data';
import { DEFAULT_USDT_ID } from 'constants/account';
import {
  selectAddCoinToGame,
  selectAddGameId,
...
const OtpInput = memo(({ phone, onSendBack }: Props) => {
  ...
  const handleCompleteOtpInput = () => {
    ...
    const payload: WithdrawRequestGame = {
      otp: otp,
    ...
    dispatch(withdrawActions.requestCreateCoinToGameWithdraw(payload));
  };
