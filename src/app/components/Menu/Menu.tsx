...
import { Avatar, Card, Container, Flex, Group, Stack, Text, createStyles } from '@mantine/core';
        ...
        <Card className={classes.menu} ref={modalRef}>
          <Flex className={classes.header}>
            <Group className={classes.info}>
              ...
              <div>
                ...
                <Text className={cx('small_3-regular', classes.userId)}>@NAThu</Text>
              </div>
            </Group>
          ...
          <Stack className={classes.menuItem}>
            {navArray.map((nav, index) => (
              <NavLink key={index} to={nav.navigate} className={classes.navItem}>
                {nav.icon}
